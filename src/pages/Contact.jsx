...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://formsubmit.co/ajax/hr@insertsol.com", {
        method: "POST",
        headers: {
                ...
                <div className="space-y-8">
                  <motion.div variants={fadeIn} className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-slate-600">hr@insertsol.com</p>
                    </div>
                  </motion.div>
                  ...
                  <motion.div variants={fadeIn} className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-slate-600">+91 9573705544 </p>
