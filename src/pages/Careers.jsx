    ...
    <div className="w-full bg-white pt-24">
      ...
      <section className="relative py-24 lg:py-32 bg-gradient-soft text-center border-b border-slate-100">
        <div className="container mx-auto px-6 lg:px-12">
          ...
          >
            <h1 className="text-5xl md:text-7xl font-extrabold mb-6 tracking-tight text-slate-900 uppercase">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            >
              <div className="aspect-[4/3] saas-card bg-slate-50 flex flex-col justify-center items-center text-center relative overflow-hidden p-8">
                 ...
                 <h3 className="text-2xl font-bold text-slate-900 relative z-10 mb-4">Empowering Talent</h3>
            ...
            >
              ...
              <motion.h2 variants={fadeIn} className="text-4xl md:text-5xl font-extrabold mb-6 text-slate-900 leading-tight">
      ...
      <section className="py-24 lg:py-32 bg-secondary border-b border-slate-100">
        <div className="container mx-auto px-6 lg:px-12">
          <div className="text-center mb-20 max-w-3xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-extrabold mb-6 text-slate-900">Benefits of <span className="text-accent">Joining Us</span></h2>
        ...
        <div className="container mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            >
              ...
              <motion.h2 variants={fadeIn} className="text-4xl md:text-5xl font-extrabold mb-8 text-slate-900 leading-tight">
                Life at insertSol
              </motion.h2>
            ...
            >
              <div className="aspect-[4/3] saas-card bg-slate-50 flex flex-col items-center justify-center relative overflow-hidden p-8">
                 ...
                 <h4 className="text-xl font-bold text-slate-900 relative z-10 mb-2">Knowledge-Sharing</h4>
